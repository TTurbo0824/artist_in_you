...
var quizQuestions = [
  ...
  // question #3
  {
    question: "You heard there is an exhibition of the artist you like.",
    answers: [
      {
        type: 'J',
  ...
  // question #4
  {
    question: "What will you do before you go to the exhibition?",
    answers: [
      {
        type: 'T',
  ...
  // question #5
  {
    question: "At the very last minute, your friend canceled plans to visit the exhibition together. What will you do?",
    answers: [
      {
        type: 'E',
  ...
  // question #8
  {
    question: "You've just entered the exhibition space, and the docent tour is about to begin!",
    answers: [
      {
        type: 'E',
  ...
  // question #9
  {
    question: "You're standing in front of an esoteric but yet eye-catching painting.",
    answers: [
      {
        type: 'J',
