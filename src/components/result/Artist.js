const Artist = [{
    ...
    },
    {
        ...
        "facts": ["Edward Hopper was an extremely tall man, standing at 6 feet 5 inches.",
            ...
            "His wife Josephine gave more than 3,000 works of Edward Hopper to the Whitney Museum."
        ]
    },
    {
        "id": 2,
        ...
        "image": "picasso",
        "facts": ["Picasso's full name has 23 words.",
            "Picasso was dyslexic and didn't do well in school. He was often thrown into detention.",
            "He claimed \"Paul Cézanne was my one and only master.\"",
            "In 1911, Picasso was suspected of stealing the Mona Lisa from Paris's Louvre Museum.",
            "Picasso had a keen interest in poetry. He wrote hundreds of poems, mostly during the 1940 and 1950s."
        ]
    },
    {
        "id": 3,
        ...
        "image": "okeeffe",
        "facts": ["She created more than 200 paintings of flowers.",
            "O'keeffe loved to drive in her Ford Model A. She had it customized into a miniature studio.",
            "She broke the record for the most expensive painting by a woman artist.",
            "There is a fossil named after her.",
            "--"
        ]
    },
    {
        ...
        "date": "Salvador Dali (1904-1989)",
        "description": "Vibrant, talented, and full of imagination, you resemble Salvador Dali, the iconic Spanish Surrealist artist.",
        "image": "dali",
        "facts": ["Dalí's parents believed he was his older brother reincarnated.",
            ...
            "In 1969, Dalí came up the Chupa Chups logo within an hour.",
    ...
    },
    {
        ...
        "image": "golub",
        "facts": ["During World War II, Leon Golub served in the military as an army cartographer.",
            ...
            "In the late 1970s, Golub painted over a hundred portraits of political and religious leaders."
        ]
    },
    {
        "id": 7,
        ...
        "facts": ["As a child, Frida Kahlo wanted to be a doctor, with art being a side hobby.",
            "Frida kept many, some exotic, pets such as dogs, deer, birds and monkeys.",
            "Kahlo appeared in Vogue, October 1937 issue.",
            "In 1940, she was placed in jail as a murder suspect.",
